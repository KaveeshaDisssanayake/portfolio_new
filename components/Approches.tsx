  ...
  return (
    <section className="w-full py-20" id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description ="Skilled in planning and strategy, ensuring project success through careful analysis, detailed roadmaps, and effective execution."
        ...
        description = "Regularly provide development and progress updates, ensuring clear communication and transparency throughout project lifecycles."
        ...
        description ="Specialized in development and launch of web applications, ensuring seamless deployment and exceptional user experiences."
